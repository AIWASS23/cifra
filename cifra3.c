    ...
    do {
        ...
        switch(ValRef) {
            ...
            case 2:
                ...
                break;
            case 3:
                printf("Adeus e deus ti abençoe");
                break;
            default:
                printf("Tá errado Corno");
                break;
        }
    }while(opc == 3);
}
...
void menu() {
    ...
    do {
        date();
        printf("\n1.-Cifra de Playfair\n2.-Cifra de Vigenere\n3.-Cifra por Transposiçao con Chave\n4.-Salir\n");
        scanf("%i",&opc);
        switch(opc){
            case 1:
                submenu(opc);
            ...
            case 4:
                ...
                break;
            default:
                printf("Ta errado moi de chifre");
                break;
        }
    }while(opc != 4);
}
