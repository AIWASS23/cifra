...
void exibirTextoOriginalFormatado(int inicio, char *buffer) {
   //Timer tempo;
    ...
    char chave[6] = "PIZZA"; // Define a chave de criptografia
    ...
    //tempo.stop();
    //printf("\nTEMPO original Mbed: %lld microsegundos",tempo.read_high_resolution_us());
    //meuLed = 0;
}
...
void wrapDesencriptar(int inicio, char *buffer) {
    ...
    char chave[6] = "PIZZA"; // Define a chave de descriptografia
    ...
    tempo.stop();
    printf("\nTEMPO desencriptar Mbed: %lld microsegundos",tempo.read_high_resolution_us());
    meuLed = 0;
}
